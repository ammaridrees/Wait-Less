...
public class Restaurant extends TimerTask implements Comparable<Restaurant> {
...
public Restaurant getTotalCost() {
	return totalCost;
}

public void setTotalCost(Restaurant totalCost) {
