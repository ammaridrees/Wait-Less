...
public class Tabledisplay extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
	  ...
	  public static boolean isClicked1, isClicked2, isClicked3, isClicked4, isClicked5, isClicked6, isClicked7, isClicked8 = false;
	    ...
	    protected JButton tbl1Button1, tblButton2, tbl3Button, tbl4Button, tbl5Button, button_5, tblButton7, tblButton8, update;
	    ...
	    public Tabledisplay() {
			...
			//    Comparator comp = queue.comparator();
			  ...
			  //  System.out.println(queue);
			   ...
			   //System.out.println(Loader.T3.getTotalCost());
			...
			routing1.setBounds(1312, 164, 217, 222);
			contentPane.add(routing1);
			//maaz.addElement("hi");
			...
			update = new JButton();
			update.setBounds(1200, 234, 100, 54);
			...
			JLabel lblOptimalRoute = new JLabel("Optimal Route");
			lblOptimalRoute.setFont(new Font("Lucida Grande", Font.PLAIN, 26));
			lblOptimalRoute.setForeground(Color.WHITE);
			lblOptimalRoute.setBounds(1312, 124, 223, 28);
			contentPane.add(lblOptimalRoute);
		...
		@Override
		 public void actionPerformed(ActionEvent e) {
		        ...
		        if ("One".equals(e.getActionCommand()) && !isClicked1) {
					...
					System.out.println(totTime);
					divider++;					tbl4Button.setBackground(Color.LIGHT_GRAY);
					tbl4Button.setOpaque(true);
					tbl4Button.setBorderPainted(false);
					System.out.println("working");
					available++;
